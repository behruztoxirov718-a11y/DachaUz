...
import { Search, MapPin, Users, Star, Calendar, Home as HomeIcon, ArrowRight, Bed, Loader2 } from 'lucide-react';
    ...
    >
      <div className="relative h-52 bg-gradient-to-br from-green-100 to-green-200 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm rounded-full px-2.5 py-1 flex items-center gap-1 text-sm font-semibold text-yellow-600">
          <Star size={14} fill="currentColor" /> {dacha.rating}
        </div>
        {!dacha.isAvailable && (
      ...
      <div className="p-4">
        ...
        <p className="text-gray-500 text-sm mb-3 flex items-center gap-1">
          <MapPin size={14} /> {dacha.district}, {dacha.location}
        </p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-green-900 via-green-800 to-green-700 text-white overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-green-100 text-lg mb-10 max-w-xl mx-auto">
            Chorvoq, Parkent, Ohangaron... Oila va dostlar bilan unutilmas dam olish
          </p>
          ...
          <div className="bg-white rounded-2xl p-4 max-w-2xl mx-auto shadow-2xl">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <button
                ...
                className="bg-green-700 hover:bg-green-600 text-white font-bold px-8 py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
              >
          ...
          <div className="flex justify-center gap-10 mt-10 text-center">
            <div>
              <div className="text-3xl font-extrabold text-white">{dachalar.length || '0'}+</div>
      ...
      <section className="bg-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center text-gray-800 mb-10">Qanday ishlaydi?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              { Icon: Search,   step: '1', title: 'Dacha tanlang', desc: "Joy, narx va qulayliklar boyicha filter qiling" },
              { Icon: Calendar, step: '2', title: 'Bron qiling',   desc: "Sana va mehmonlar sonini kiriting, sorov yuboring" },
      ...
      <section className="py-14 px-4 max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          >
            Hammasini korish <ArrowRight size={16} />
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {featuredDachalar.map((dacha) => <DachaCard key={dacha.id} dacha={dacha} />)}
          </div>
        ) : (
          <div className="text-center py-20 text-gray-400">
            <HomeIcon size={64} className="mx-auto mb-4" strokeWidth={1} />
            <p>Hozircha dachalar yoq</p>
          </div>
        )}
      </section>
      ...
      <section className="bg-green-50 py-14 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-800 mb-8 text-center flex items-center justify-center gap-2">
            <MapPin size={22} /> Mashhur hududlar
          </h2>
      ...
      <section className="bg-green-800 text-white py-16 px-4 text-center">
        ...
        <p className="text-green-200 mb-8 max-w-md mx-auto">
          Yozda bosh turadigan dachaingizdan daromad oling. Royxatdan otish bepul!
        </p>
        <a
          href="https://t.me/your_telegram"
          target="_blank"
          rel="noreferrer"
          className="inline-block bg-white text-green-800 font-bold px-8 py-3 rounded-xl hover:bg-green-50 transition-colors"
        >
